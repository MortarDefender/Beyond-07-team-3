...
from .participent_models import EventParticipant
...
def validate_unique_possible_meeting(participant, date_time_start, date_time_end):
    if PossibleMeeting.objects.filter(participant_id=participant, date_time_start=date_time_start,
